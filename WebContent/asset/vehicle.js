...
$('#btn').click(function(){
	...
	$.getJSON('SearchVehicleByRFIDJSON',{ajax:true, rfid:$('#rfid').val()},function(data){
			...
			htm+='<tr><td><b><i>Vehicle Id/Reg. NO.:</i></b></td><td>'+data[0].VEHICLEID+' '+data[0].REGISTRATIONNO+'</td><td><b><i>RFID:</i></b></td><td>'+data[0].REFERENCEID+'</td></tr>';
			htm+='<tr><td><b><i>Mobile Number:</i></b></td><td>'+data[0].MOBILENO+'</td><td><b><i>Date/Time:</i></b></td><td>'+data[0].CURRENTDATE+' '+data[0].CURRENTTIME+'</td></tr>';
